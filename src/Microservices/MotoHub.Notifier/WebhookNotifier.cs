...
public static class WebhookNotifier
{
    ...
    private const string WebhookUrl = "https://webhook.site/71fc835f-f5f2-4ab9-8663-6ccbeaedea62"; // Somente para testes
    ...
    public static async Task SendAsync(object message, ILambdaContext context, Exception? exception = null)
    {
        ...
        response.EnsureSuccessStatusCode(); // lança erro se falhar (para debug em CloudWatch)
    }
}
